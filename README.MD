...
## Wireframes
To plan the site layout, the below wireframes were created for the Home, Timetable, Members Area and Admin pages. For each page, the desktop and mobile view was sketched out.
- Home
